...
import br.com.phs.jtg.huds.HighScoreButtons
...
class HighScore(private val game: GameMain) : Screen{

    private var mainCamera: OrthographicCamera = OrthographicCamera()
    private var gameViewport: Viewport
    private var bg: Texture
    private lateinit var btns: HighScoreButtons
    ...
    init {
        ...
        bg = Texture("Backgrounds/Highscore BG.png")

        btns = HighScoreButtons(game)
    }
